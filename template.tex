...
\begin{spreadtab}{{tabular}[t t t]{lp{8.2cm}r}}
  \hdashline[1pt/1pt]
  @ \noalign{\vskip 2mm} \textbf{Pos.} & @ \textbf{Aktivität} & @ \textbf{Preis in $currency$} \\ \hline
  ...
  $if(VAT)$
    @ & @ \multicolumn{1}{r}{Summe Honorare:}                & :={sum(c1:[0,-1])} \\ \hhline{~~-}
    @ & @ \multicolumn{1}{r}{Umsatzsteuer $VAT$\%:}               & $VAT$/100*[0,-1] \\ \hhline{~~-}
  $endif$
